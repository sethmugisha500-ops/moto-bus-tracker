// admin-dashboard/app/drivers/moto/page.tsx
'use client';

import { useState, useEffect, useCallback } from 'react';
import { 
  Bike, Search, Star, Eye, CheckCircle, XCircle, 
  Loader2, RefreshCw, Filter, ChevronDown, User,
  Phone, MapPin, Calendar, Award, DollarSign,
  AlertCircle, UserCheck, UserX, Clock, Wifi,
  WifiOff, MoreVertical, Edit, Trash2, 
  UserPlus, Shield, Zap, Target, BarChart3,
  Crown, Activity, TrendingUp, Users, Mail
} from 'lucide-react';
...
const api = {
  getDrivers: async (params: {
    ...
    page?: number;
    limit?: number;
  }): Promise<{ data: Driver[]; stats: Stats; pagination: any }> => {
  ...
  getDriverDetails: async (driverId: string): Promise<{ data: Driver }> => {
    const token = localStorage.getItem('token');
...
const StatCard = ({ icon: Icon, label, value, color, subtitle, onClick }: any) => (
  <div 
    onClick={onClick}
    className="bg-[#111714] border border-gray-800 rounded-xl p-4 hover:border-orange-500/30 transition-all cursor-pointer group"
  >
...
const DriverCard = ({ 
  ...
  return (
    <div className="bg-[#111714] border border-gray-800 rounded-xl p-4 hover:border-orange-500/30 transition-all group">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <div className="flex items-center gap-4">
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-gray-400">{driver.vehicleModel}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1">
            {!driver.isApproved ? (
              ...
              <>
                ...
                >
                  <Eye size={16} className="text-gray-400 hover:text-orange-500" />
                </button>
                {driver.isActive && (
                  <button
    ...
    return (
      <div className="min-h-screen bg-[#080C09] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm">Loading moto drivers...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap justify-between items-center gap-3 mb-6">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <h1 className="text-2xl font-bold">Moto Drivers</h1>
              <span className="text-sm text-gray-400 bg-[#0A0E0B] px-3 py-1 rounded-full border border-gray-800">
                {pagination.total} total
              </span>
            </div>
            <p className="text-sm text-gray-400">Manage motorcycle taxi drivers</p>
          </div>
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-3 py-2 bg-[#0A0E0B] border border-gray-800 rounded-lg text-sm text-white focus:outline-none focus:border-orange-500 transition placeholder-gray-500 w-48"
              />
            </div>
            <select
              value={statusFilter}
              ...
              className="px-3 py-2 bg-[#0A0E0B] border border-gray-800 rounded-lg text-sm text-white focus:outline-none focus:border-orange-500 transition"
            >
            ...
            >
              <RefreshCw size={16} className={refreshing ? 'animate-spin text-orange-500' : 'text-gray-400'} />
            </button>
          </div>
        </div>
        ...
        {error && (
          <div className="mb-4 p-3 bg-red-500/10 border border-red-500/20 rounded-xl text-red-400 text-sm flex items-center gap-2">
            <AlertCircle size={16} />
            {error}
            <button onClick={fetchDrivers} className="ml-auto text-orange-500 hover:underline">Retry</button>
          </div>
        )}
        ...
        <div className="space-y-3">
          {drivers.length === 0 ? (
            <div className="bg-[#111714] border border-gray-800 rounded-xl p-12 text-center">
              <Bike size={48} className="text-gray-600 mx-auto mb-4" />
              <p className="text-gray-400 text-lg">No moto drivers found</p>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-[#111714] rounded-t-2xl z-50 p-6 animate-slide-up border-t border-gray-800 max-h-[85vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
              ...
              <div className="bg-[#0A0E0B] rounded-lg p-3 border border-gray-800">
                ...
                <p className="font-semibold text-white">{new Date(selectedDriver.joinedAt).toLocaleDateString()}</p>
              </div>
            </div>
