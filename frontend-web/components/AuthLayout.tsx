    ...
    <>
      <style jsx global>{`
        ...
        :root {
          ...
          --bh: rgba(0,194,111,0.28);
          --t: #EFF4F0;
          --m: rgba(239,244,240,0.45);
          --err: #FF6464;
          --err-bg: rgba(255,100,100,0.08);
        ...
        *::after {
        ...
        @keyframes pulse-ring {
          0%,
          100% {
            box-shadow: 0 0 0 0 rgba(0,194,111,0.4);
          }
          50% {
            box-shadow: 0 0 0 8px rgba(0,194,111,0);
          }
        }
